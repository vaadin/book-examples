...
public class BookExampleLibrary {
    ...
    final AbstractExampleItem examples[] = {
            ...
            new BookExample("component.datefield.resolution-day", "Day Resolution", DateFieldExample.class),
            ...
            new BookExample("layout.orderedlayout.sizing.sizing-relative", "Relative Size", OrderedLayoutExample.class),
            ...
            new ExampleCtgr("misc.addons-", "Serialization"),
