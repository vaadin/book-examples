...
public class BookExamplesUI extends UI {
    ...
    private static final transient Logger logger = Logger
            .getLogger(BookExamplesUI.class.getName());
    ...
    protected void init(VaadinRequest request) {
        ...
        getLogger().info("MaxInactiveInterval " + VaadinSession.getCurrent()
    ...
    @WebServlet(value = { "/book/*",
            "/VAADIN/*" }, name = "BookExamplesUI", asyncSupported = true)
    @VaadinServletConfiguration(ui = BookExamplesUI.class, productionMode = false)
    public static class BookExamplesUIServlet extends MyCustomServlet {
    }
}
