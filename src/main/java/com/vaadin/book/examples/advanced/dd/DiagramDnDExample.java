...
public class DiagramDnDExample extends CustomComponent implements AnyBookExampleBundle {
    ...
    class ConnectorSource implements StreamResource.StreamSource {
        ...
        transient ByteArrayOutputStream imagebuffer = null;
        
        public class Connector implements Serializable {
            private static final long serialVersionUID = 1938682317693739778L;
    ...
    public void diagram(VerticalLayout layout) {
        ...
        connectorResource = new StreamResource(connectors, makeImageFilename());
        
        // A connector canvas that is beneath everything else
        canvas = new Image(null, connectorResource);
        ...
        layout.addStyleName("componentdndexample");
    }
