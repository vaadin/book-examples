...
import com.vaadin.book.examples.lib.EmboExample.EmbeddingType;
import com.vaadin.book.examples.misc.ExceptionExamples;
import com.vaadin.book.examples.misc.I18nPrototype;
import com.vaadin.book.examples.misc.ItemContainerExample;
...
public class BookExampleLibrary {
    ...
    final AbstractExampleItem examples[] = {
            ...
            new BookExample("component.field.validation.stringlengthvalidator", "String Length Validator", ValidationExample.class),
            ...
            new BookExample("component.grid.selection.single", "Single-Select Mode", GridExample.class),
            ...
            new BookExample("misc.itemcontainer.basic", "Basic Use", ItemContainerExample.class),
        };
}
